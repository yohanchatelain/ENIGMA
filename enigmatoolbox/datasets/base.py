...
if pd.__version__ >= "1.3.0":
    badlines_handler = dict(on_bad_lines="skip")
else:
    badlines_handler = dict(error_bad_lines=False)
...
def load_conte69(as_sphere=False, with_normals=True, join=False):
    ...
    surfs: list = [None] * 2  # Updated type hint to a generic list
...
def load_sc(parcellation="aparc"):
    ...
    return (
        np.loadtxt(ctx_ipth, dtype=float, delimiter=","),
    ...
    for kk in range(zdata.shape[0]):
        for ii in range(zdata.shape[1]):
            for jj in range(zdata.shape[1]):
                joint_var_matrix[ii, jj, kk] = 1 / np.exp(
                    np.square(zdata[kk, ii] - zdata[kk, jj])
                )
    return joint_var_matrix


def fetch_ahba(csvfile: str | None = None):
    ...
    if csvfile is None:
        url: str = (
            "https://raw.githubusercontent.com/saratheriver/enigma-extra/master/ahba/allgenes_stable_r0.2.csv"
        )
        return pd.read_csv(url, **badlines_handler)
    else:
        return pd.read_csv(csvfile, **badlines_handler)
...
def risk_genes(disorder=None):
    ...
    if disorder == "adhd":
        ...
        return {
            "allepilepsy": allepilepsy,
            "focalepilepsy": focalepilepsy,
            "generalizedepilepsy": generalizedepilepsy,
            "jme": jme,
            "cae": cae,
            "focalhs": focalhs,
        }
...
def load_example_data():
    ...
    return (
        pd.read_csv(cov, **badlines_handler),
        pd.read_csv(metr1, **badlines_handler),
        pd.read_csv(metr2, **badlines_handler),
        pd.read_csv(metr3, **badlines_handler),
    )
...
def load_summary_stats(disorder=None):
    ...
    if disorder == "22q":
        CortThick_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        CortThick_psychP_psychN = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_psych+-psych-_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_psychP_psychN = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_psych+-psych-_CortSurf.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_AB = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_case-controls_SubVol_AB.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_AD = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_case-controls_SubVol_AD.csv"
            ),
            **badlines_handler,
        )
        SubVol_AB_AD = pd.read_csv(
            os.path.join(root_pth, "summary_statistics", "22q_AB-AD_SubVol.csv"),
            **badlines_handler,
        )
        SubVol_psychP_psychN = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "22q_psych+-psych-_SubVol.csv"
            ),
            **badlines_handler,
        )

        return {
            "CortThick_case_vs_controls": CortThick_case_controls,
        ...
        CortSurf_case_controls_allages = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdallages_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdadult_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdadult_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        ...
        CortThick_case_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_controls_allages = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdallages_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdadult_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        ...
        SubVol_case_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "adhdpediatric_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )

        return {
            "CortThick_case_vs_controls_allages": CortThick_case_controls_allages,
        ...
        return {
            "CortThick_case_vs_controls_meta_analysis": CortThick_case_controls_meta_analysis,
        ...
        CortThick_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_case-controls_CortThick_adult.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_case-controls_CortSurf_adult.csv"
            ),
            **badlines_handler,
        )
        CortThick_typeI_typeII_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_typeI-typeII_CortThick_adult.csv"
            ),
            **badlines_handler,
        )
        CortSurf_typeI_typeII_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_typeI-typeII_CortSurf_adult.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_adolescent = pd.read_csv(
        ...
        SubVol_case_controls_typeI = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_case-controls_SubVol_typeI.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_typeII = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "bd_case-controls_SubVol_typeII.csv"
            ),
            **badlines_handler,
        )
        SubVol_typeII_typeI = pd.read_csv(
            os.path.join(root_pth, "summary_statistics", "bd_typeII-typeI_SubVol.csv"),
            **badlines_handler,
        )
        ...
        CortThick_case_vs_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddadult_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_vs_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddadult_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_vs_controls_adult_firstepisode = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adult_firstepisode = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_vs_controls_adult_recurrent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adult_recurrent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_firstepisode_vs_recurrent_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_firstepisode_vs_recurrent_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_vs_controls_adult_early = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adult_early = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_vs_controls_adult_late = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adult_late = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_early_vs_late_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddadult_early-late_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_early_vs_late_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddadult_early-late_CortSurf.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_vs_controls_adolescent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adolescent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_vs_controls_adolescent_firstepisode = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adolescent_firstepisode = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_vs_controls_adolescent_recurrent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_case_vs_controls_adolescent_recurrent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_firstepisode_vs_recurrent_adolescent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_firstepisode_vs_recurrent_adolescent = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mdd_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_vs_controls_late = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddlate_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_vs_controls_early = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddearly_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_late_vs_early = pd.read_csv(
            os.path.join(root_pth, "summary_statistics", "mdd_late-early_SubVol.csv"),
            **badlines_handler,
        )
        SubVol_case_vs_controls_firstepisode = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_recurrent = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mddrecurrent_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_recurrrent_vs_firstepisode = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "mdd_recurrent-firstepisode_SubVol.csv"
            ),
            **badlines_handler,
        )

        return {
            "CortThick_case_vs_controls_adult": CortThick_case_vs_controls_adult,
        ...
        CortThick_case_controls_allepilepsy = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "allepi_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_allepilepsy = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "allepi_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_gge = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "gge_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_gge = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "gge_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_ltle = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "tlemtsl_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_ltle = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "tlemtsl_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_rtle = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "tlemtsr_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_rtle = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "tlemtsr_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        CortThick_case_controls_allotherepilepsy = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_controls_allotherepilepsy = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "allotherepi_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )

        return {
            "CortThick_case_vs_controls_allepilepsy": CortThick_case_controls_allepilepsy,
        ...
        CortThick_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadults_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadults_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        CortThick_medicatedcase_controls_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_medicatedcase_controls_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_medicatedcase_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortSurf_medicatedcase_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadult_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_medicatedcase_vs_controls_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_unmedicatedcase_vs_controls_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_medicatedcase_vs_unmedicated_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_adult_late = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadult_case-controls_SubVol_late.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_vs_controls_adult_early = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_late_vs_early_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadult_late-early_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_vs_controls_adult_depression = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_adult_nodepression = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_depression_vs_nodepression_adult = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_adult_anxiety = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_case_vs_controls_adult_noanxiety = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_anxiety_vs_noanxiety_adult = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdadult_anxiety-noanxiety_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_vs_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "ocdpediatric_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_medicatedcase_vs_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_unmedicatedcase_vs_controls_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        SubVol_medicatedcase_vs_unmedicated_pediatric = pd.read_csv(
            os.path.join(
                root_pth,
                "summary_statistics",
        ...
        CortThick_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "scz_case-controls_CortThick.csv"
            ),
            **badlines_handler,
        )
        CortSurf_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "scz_case-controls_CortSurf.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "scz_case-controls_SubVol.csv"
            ),
            **badlines_handler,
        )
        SubVol_case_controls_mean = pd.read_csv(
            os.path.join(
                root_pth, "summary_statistics", "scz_case-controls_SubVol_mean.csv"
            ),
            **badlines_handler,
        )
...
def reorder_sum_stats(in_file, out_file):
    ...
    """
    # Load in_fil
    in_file = pd.read_csv(in_file, **badlines_handler)
    ...
    for j in range(len(d_orig)):
        newidx = np.append(
            newidx,
            [i for i, e in enumerate(in_file["Structure"].to_list()) if e == d_orig[j]],
        )
...
def nfaces(surface_name, hemisphere):
    ...
    if surface_name == "fsa5":
        if hemisphere == "lh":
            ...
            return (
                load_fsa5()[0].GetPolys2D().shape[0]
                + load_fsa5()[1].GetPolys2D().shape[0]
            )
        ...
        if hemisphere == "lh":
            ...
            return (
                load_conte69()[0].GetPolys2D().shape[0]
                + load_conte69()[1].GetPolys2D().shape[0]
            )
...
def getaffine(surface_name, hemisphere):
    ...
    if surface_name == "fsa5":
        if hemisphere == "lh" or "rh":
            return np.asarray(
                [
                    [-1.000e00, 0.000e00, 0.000e00, 5.121e03],
                    [0.000e00, 0.000e00, 1.000e00, -5.000e-01],
                    [0.000e00, -1.000e00, 0.000e00, 5.000e-01],
            ...
            return np.asarray(
                [
                    [-1.0000e00, 0.0000e00, 0.0000e00, 1.0242e04],
                    [0.0000e00, 0.0000e00, 1.0000e00, -5.0000e-01],
                    [0.0000e00, -1.0000e00, 0.0000e00, 5.0000e-01],
        ...
        if hemisphere == "lh" or "rh":
            return np.asarray(
                [
                    [-1.0000e00, 0.0000e00, 0.0000e00, 1.6246e04],
                    [0.0000e00, 0.0000e00, 1.0000e00, -5.0000e-01],
                    [0.0000e00, -1.0000e00, 0.0000e00, 5.0000e-01],
                    [0.0000e00, 0.0000e00, 0.0000e00, 1.0000e00],
                ]
            ...
            return np.asarray(
                [
                    [-1.0000e00, 0.0000e00, 0.0000e00, 3.2492e04],
                    [0.0000e00, 0.0000e00, 1.0000e00, -5.0000e-01],
                    [0.0000e00, -1.0000e00, 0.0000e00, 5.0000e-01],
                    [0.0000e00, 0.0000e00, 0.0000e00, 1.0000e00],
                ]
...
def write_cifti(
    data, dpath=None, fname=None, labels=None, surface_name="conte69", hemi="lh"
):
    ...
    ref_ds = nib.load(
        os.path.join(
            root_pth, "import_export", hemi + "." + surface_name + "_ref.dscalar.nii"
        )
    )
